...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-5.12-kirby-problem-5.12-1994cdc9-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-5.12"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-5.12-kirby-problem-5.12-1994cdc9-v1",
      "problem_contract_sha256": "058869665be3a1755e9f29f4b8583b05edef30f49405bdea523e7066d5519a8f",
      "problem_id": "problem:um-kp-5.12-kirby-problem-5.12-1994cdc9",
      "route_id": "route:um-kp-5.12-kirby-problem-5.12-1994cdc9-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-5.12-kirby-problem-5.12-1994cdc9-source-fidelity-01",
      "graph_id": "graph:um-kp-5.12-kirby-problem-5.12-1994cdc9-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-5.12-kirby-problem-5.12-1994cdc9-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-5.12-kirby-problem-5.12-1994cdc9-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(Zeeman Conjecture). If $K$ is a finite contractible 2-complex, then $K\\times I$ collapses to a point [Zee64, Conjecture (1)]."
          },
          "statement_sha256": "81beb4052f1c8e3d5a9e3378213faa1c21d3e0c70472115771e28bb57bb226c1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-5.12-kirby-problem-5.12-1994cdc9-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-5.12-kirby-problem-5.12-1994cdc9-root",
      "route_id": "route:um-kp-5.12-kirby-problem-5.12-1994cdc9-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-5.12-2dd3b0b148d3",
        "url": "https://www.unsolvedmath.com/problems/KP-5.12"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
